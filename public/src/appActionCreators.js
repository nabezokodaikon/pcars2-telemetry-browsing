...
export function receivedAggregateTime(receivedAggregateTime) {
  return {
...
export function receivedTelemetrySummary(receivedTelemetrySummary) {
  return {
    ...
    return beginConnectWebSocket(connectionInfo)
      .then(ws => {
        ...
        ws.onclose = e => {
          ...
          if (event.code == 1000) {
            console.log(
              "WebSocket was closed. Status code: " +
                e.code +
